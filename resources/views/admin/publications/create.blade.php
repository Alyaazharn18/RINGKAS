...
@section('title', 'Upload Publikasi Baru - Sistem Ringkasan & Manajemen Publikasi Statistik BPS')
...
<div class="w-full space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="heading-font text-2xl font-extrabold text-bps-navy tracking-tight">Upload Publikasi Baru</h1>
            <p class="text-sm text-slate-400 font-medium mt-0.5">Tambah berkas publikasi statistik BPS ke dalam sistem.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md border border-slate-100 p-8">
        <form action="{{ route('publications.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            @if ($errors->any())
                <div id="error-alert" class="fade-in flex items-center justify-between gap-3 bg-rose-50 border border-rose-200/60 text-rose-800 px-5 py-4 rounded-2xl text-sm shadow-sm transition-all duration-300 mb-6" role="alert">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <span class="font-bold">Gagal Mengunggah Publikasi:</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5 relative" id="category-dropdown-container">
                    ...
                    <select name="category" id="category" required class="sr-only">
                        ...
                        <option value="Publikasi Umum" {{ old('category') === 'Publikasi Umum' ? 'selected' : '' }}>Publikasi Umum</option>
                        <option value="Statistik Sosial" {{ old('category') === 'Statistik Sosial' ? 'selected' : '' }}>Statistik Sosial</option>
                        <option value="Statistik Ekonomi" {{ old('category') === 'Statistik Ekonomi' ? 'selected' : '' }}>Statistik Ekonomi</option>
                        <option value="Statistik Pertanian" {{ old('category') === 'Statistik Pertanian' ? 'selected' : '' }}>Statistik Pertanian</option>
                        <option value="Statistik Industri" {{ old('category') === 'Statistik Industri' ? 'selected' : '' }}>Statistik Industri</option>
                        <option value="Statistik Distribusi" {{ old('category') === 'Statistik Distribusi' ? 'selected' : '' }}>Statistik Distribusi</option>
                        <option value="Statistik Lingkungan" {{ old('category') === 'Statistik Lingkungan' ? 'selected' : '' }}>Statistik Lingkungan</option>
                        <option value="Sensus & Survei" {{ old('category') === 'Sensus & Survei' ? 'selected' : '' }}>Sensus & Survei</option>
                    </select>
            ...
            <div class="space-y-1.5">
                <label class="text-xs font-bold text-slate-600 uppercase tracking-wider block">Unggah Berkas PDF</label>
                ...
                <div class="relative border-2 border-dashed @error('pdf') border-rose-300 bg-rose-50/10 @else border-slate-200 bg-slate-50/50 hover:bg-slate-50 @enderror hover:border-bps-primary rounded-2xl p-6 transition-all duration-200 text-center">
                    ...
                    <div class="flex flex-col items-center justify-center space-y-2 pointer-events-none" id="upload-prompt">
                        ...
                        <p class="text-xs font-bold text-slate-700">Klik atau seret file PDF Anda di sini</p>
                    ...
                    <div class="hidden flex-col items-center justify-center space-y-2" id="file-info">
                        ...
                        <p class="text-xs font-bold text-emerald-700" id="file-name">NamaFile.pdf</p>
                        <p class="text-[10px] text-slate-400 font-medium" id="file-size">Ukuran: -</p>
