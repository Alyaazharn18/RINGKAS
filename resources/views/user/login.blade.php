...
<head>
    ...
    <title>Masuk User - RINGKAS</title>
    ...
    <div class="relative z-10 w-full max-w-[460px] bg-white rounded-[32px] shadow-[0_10px_40px_rgba(15,42,74,0.08)] border border-slate-100 p-8 md:p-10 transition-all duration-300 hover:shadow-[0_15px_50px_rgba(15,42,74,0.12)]">
        ...
        <div class="flex flex-col items-center text-center mb-8">
            ...
            <p class="text-sm text-slate-400 mt-2 font-medium">
                Silakan login sebagai User Umum
            </p>
        </div>

        <!-- Alert Notifications -->
        @if (session('success'))
            <div class="fade-in mb-6 flex items-start gap-3 bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3.5 rounded-2xl text-sm" role="alert">
            ...
            <div class="space-y-1">
                ...
                <div class="relative group">
                    ...
                    <input 
                        ...
                        required 
                        value="{{ old('username') }}"
                        class="w-full pl-11 pr-4 py-3.5 bg-slate-50/50 border border-slate-200 rounded-2xl text-[15px] text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-bps-lightBlue focus:ring-4 focus:ring-blue-100/50 transition-all duration-200" 
            ...
            <div class="space-y-1">
                ...
                <div class="relative group">
                    ...
                    <input 
                        ...
                        id="password" 
                        required 
                        class="w-full pl-11 pr-12 py-3.5 bg-slate-50/50 border border-slate-200 rounded-2xl text-[15px] text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-bps-lightBlue focus:ring-4 focus:ring-blue-100/50 transition-all duration-200" 
        ...
        <!-- Navigation Links -->
        <div class="mt-8 border-t border-slate-100 pt-6 text-center flex flex-col items-center gap-3 text-xs">
            <div class="text-slate-400 font-medium">
                Belum punya akun? 
                <a href="{{ route('register') }}" class="text-bps-lightBlue hover:underline font-bold">Daftar Sekarang</a>
            </div>
        </div>
    </div>
